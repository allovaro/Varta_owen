...
class SMSC(object):
	SMSC_LOGIN = "allovaro"  # логин клиента
	SMSC_PASSWORD = "kad6524541"  # пароль
	# Метод отправки SMS
	#
	...
	def _smsc_send_cmd(self, cmd, arg=""):
		...
		_url = url
		arg = "login=" + quote(self.SMSC_LOGIN) + "&psw=" + quote(self.SMSC_PASSWORD) + "&fmt=1&charset=" + SMSC_CHARSET + "&" + arg
